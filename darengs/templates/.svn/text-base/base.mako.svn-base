...
<title>DARE-NGS</title> 
  ${h.stylesheet_link(url('/style.css'))}

<link rel="stylesheet" href="${url('/newtheme/js/prettyPhoto/css/prettyPhoto.css')}" type="text/css" media="screen"/> 
<link rel="stylesheet" href="${url('/newtheme/style.css')}" type="text/css" media="screen" /> 
<link rel="stylesheet" type="text/css" media="all" href="${url('/newtheme/styles/minimal_soft_green.css')}" /> 
...
<script type='text/javascript' SRC="${url('/newtheme/js/swfobject.js')}"></script> 
<script type='text/javascript' SRC="${url('/newtheme/js/jquery/jquery.js')}"></script> 
<script type='text/javascript' SRC="${url('/newtheme/js/jquery.easing.js')}"></script> 
<script type='text/javascript' SRC="${url('/newtheme/js/cufon-yui.js')}"></script> 
<script type='text/javascript' SRC="${url('/newtheme/js/DejaVu_Sans_Condensed_400.font.js')}"></script> 
<script type='text/javascript' SRC="${url('/newtheme/js/prettyPhoto/js/jquery.prettyPhoto.js')}"></script> 
<script type='text/javascript' SRC="${url('/newtheme/js/jquery.tools.min.js')}"></script> 
<script type='text/javascript' SRC="${url('/newtheme/js/galleria/galleria.js')}"></script> 
<script type='text/javascript' SRC="${url('/newtheme/js/galleria/themes/classic/galleria.classic.js')}"></script> 
<script type='text/javascript' SRC="${url('/newtheme/js/custom.js')}"></script> 
<script type='text/javascript' SRC="${url('/newtheme/js/sliders.js')}"></script> 
...
/* <![CDATA[ */
	...
	var vvqattributes = {};
	var vvqexpressinstall = "${url('/newtheme/js/expressinstall.swf')}";
/* ]]> */
</script> 
...
<div class="body_background"> 
	<div id="header"> 
		<div class="inner"> 
			...
			<!-- logo -->
			<div id="logo"> 
				<a HREF="${url('/')}"><img SRC="${url('/newtheme/styles/minimal_soft_green/DARE.png')}" alt="" width="178" height="72" /></a>
			</div> 
	...
	%endif
      ...
      <li><a class="MenuBarItemSubmenu"> JOB SUBMISSION </a>
        <ul>
          ...
          <li ><a title="Pipeline"  href="${url('/ngs/bfast_form')}" >BFAST</a></li>
